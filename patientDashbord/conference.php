                    ...
                    <table class="tbl">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td data-label="Specialization">Eye Surgeon</td>
                                <td data-label="Doctor Name">Dr Peerera</td>
                                <td data-label="Date">31 Nov 2024</td>
                                <td data-label="Time">4:00 PM</td>
                                <td data-label="Conference"><button class="search_btn">Access</button></td>
                            </tr>
                            <tr>
                                <td data-label="Appointment No">01</td>
                                <td data-label="Specialization">Eye Surgeon</td>
